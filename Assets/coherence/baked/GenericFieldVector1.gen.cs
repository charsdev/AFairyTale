namespace Coherence.Generated
{
	...
	public struct GenericFieldVector1 : ICoherenceComponentData
	{
		...
		public static void Serialize(GenericFieldVector1 data, uint mask, IOutProtocolBitStream bitStream)
		{
			...
			{
				Coherence.Toolkit.Bounds.Check(data.Value.x, _Value_Min, _Value_Max, "GenericFieldVector1.Value.x");

				Coherence.Toolkit.Bounds.Check(data.Value.y, _Value_Min, _Value_Max, "GenericFieldVector1.Value.y");

				Coherence.Toolkit.Bounds.Check(data.Value.z, _Value_Min, _Value_Max, "GenericFieldVector1.Value.z");
