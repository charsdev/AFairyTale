...
namespace Coherence.Generated
{
	...
	public struct WorldPosition : ICoherenceComponentData
	{
		...
		public static (WorldPosition, uint, uint?) DeserializeArchetypeDirectional__char_32_Light_529987fff2cb05c448cc73d44075a64f_WorldPosition_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new WorldPosition();
			if (bitStream.ReadMask())
