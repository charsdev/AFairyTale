...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncTree : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncTree>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncTree] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
