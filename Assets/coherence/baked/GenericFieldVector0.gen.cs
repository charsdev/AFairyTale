namespace Coherence.Generated
{
	...
	public struct GenericFieldVector0 : ICoherenceComponentData
	{
		...
		public static void Serialize(GenericFieldVector0 data, uint mask, IOutProtocolBitStream bitStream)
		{
			...
			{
				Coherence.Toolkit.Bounds.Check(data.Value.x, _Value_Min, _Value_Max, "GenericFieldVector0.Value.x");

				Coherence.Toolkit.Bounds.Check(data.Value.y, _Value_Min, _Value_Max, "GenericFieldVector0.Value.y");

				Coherence.Toolkit.Bounds.Check(data.Value.z, _Value_Min, _Value_Max, "GenericFieldVector0.Value.z");
