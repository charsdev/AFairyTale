namespace Coherence.Generated
{
	...
	public struct GenericScale : ICoherenceComponentData
	{
		...
		public static void Serialize(GenericScale data, uint mask, IOutProtocolBitStream bitStream)
		{
			...
			{
				Coherence.Toolkit.Bounds.Check(data.value.x, _value_Min, _value_Max, "GenericScale.value.x");

				Coherence.Toolkit.Bounds.Check(data.value.y, _value_Min, _value_Max, "GenericScale.value.y");

				Coherence.Toolkit.Bounds.Check(data.value.z, _value_Min, _value_Max, "GenericScale.value.z");
